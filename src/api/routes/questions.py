"""Question generation and retrieval routes."""
...
router = APIRouter(prefix="/contexts/{context_id}/questions", tags=["questions"])
...
async def generate_questions(
    ...
    """Generate practice questions for a context. Stores in Dragonfly only."""
...
async def get_questions(
    ...
    """Fetch cached questions for a context."""
